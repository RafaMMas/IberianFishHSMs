...
``` {r plot substrate, echo = FALSE, warning=FALSE, fig.width = 5, fig.height = 5, out.height = "100%", dpi=800}
...
layout(matrix(1:2, ncol = 2), widths = c(1, 0.3))

op1 <- par(mar = c(4, 4, 2.5, 0.25))
...
op1 <- par(mar = c(4, 0, 8, 5))

plot(rep(0,100), seq(0, 8, length=100), pch = 15, col = Colors.substrate.index, ann = F, bty = "n", axes = FALSE, xaxs = "i", yaxs = "i")
Axis(side = 4, las = 1)
