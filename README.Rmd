...
``` {r plot cover, echo = FALSE, warning=FALSE, fig.width = 8, fig.height = 10, out.height = "100%", dpi=800}
...
``` {r plot substrate, echo = FALSE, warning=FALSE, fig.width = 8, fig.height = 5, out.height = "100%", dpi=800}

library(sf)

Coordinates <- st_as_sf(Velocity.example.df[,c("x", "y")], coords = c("x", "y"))

Colors.substrate.index <- terrain.colors(100)
...
title("Substrate index in the Serpis River reach (JRBD)", outer = T, line = -2, adj = 0.5, cex.main = 1)
