...
``` {r plot example velocity and depth, warning=FALSE, echo = FALSE, fig.width = 8, fig.height = 14, out.height = "110%", dpi=800}
...
``` {r plot cover, echo = FALSE, warning=FALSE, fig.width = 8, fig.height = 14, out.height = "110%", dpi=800}
