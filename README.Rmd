...
`Load.and.print.model` allows selecting any specific model and assigning it to an *R* object, as well as printing this model.  
...
``` {r plot example velocity and depth, warning=FALSE, echo = FALSE, dpi=800}
...
``` {r plot cover, echo = FALSE, warning=FALSE, dpi=800}
